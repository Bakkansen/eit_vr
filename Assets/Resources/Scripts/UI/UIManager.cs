...
public class UIManager : MonoBehaviour {
    ...
    [SerializeField] public ScaleController m_scaleController;
    ...
    public void SetUpQuiz(string[] answers, string t, float[] scales) {
        title.text = t;
        counter.Shuffle();        
        for (int i = 0; i < m_sliders.Count; i++) {
            ...
            m_sliders[i].SetMyScale(scales[counter[i]]);
        }
    ...
    public void LoadNextQuestion() {
        ...
        SetUpQuiz(m_quizQuestions[m_currentQuestion].answers, m_quizQuestions[m_currentQuestion].quizText, m_quizQuestions[m_currentQuestion].scales);
        m_currentQuestion++;
    }
